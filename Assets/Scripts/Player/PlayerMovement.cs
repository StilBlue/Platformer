...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void HandleRunAnimation()
    {
        ...
        animator.SetFloat("HorizontalVelocity", Math.Abs(velocity.x));
        animator.SetBool("IsOnGround", controller2D.collisions.below);
    }
    ...
    {
        return controller2D.collisions.faceDir;
    }

    public void OnSlashEnded()
    {
        isSlashing = false;
    }
}
